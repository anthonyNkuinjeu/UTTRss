...
var rows = db.execute('SELECT code FROM uvsTC WHERE typeUV = "CS" AND semestre = "Automne" ORDER BY code ');
...
rows = db.execute('SELECT code FROM uvsTC WHERE typeUV = "CS" AND semestre = "Printemps" ORDER BY code ');
...
// Rows for only TM courses
rows = db.execute('SELECT code FROM uvsTC WHERE typeUV = "TM" AND semestre = "Automne" ORDER BY code ');
...
// Rows for only TM courses
rows = db.execute('SELECT code FROM uvsTC WHERE typeUV = "TM" AND semestre = "Printemps" ORDER BY code ');
