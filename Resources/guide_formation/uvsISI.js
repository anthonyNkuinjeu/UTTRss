...
var rows = db.execute('SELECT code FROM uvsTCB WHERE typeUV = "CS" AND semestre = "Automne" AND typeBranche = "ISI" ORDER BY code ');
...
rows = db.execute('SELECT code FROM uvsTCB WHERE typeUV = "CS" AND semestre = "Printemps" AND typeBranche = "ISI" ORDER BY code ');
...
// Rows for only TM courses
rows = db.execute('SELECT code FROM uvsTCB WHERE typeUV = "TM" AND semestre = "Automne" AND typeBranche = "ISI" ORDER BY code ');
...
// Rows for only TM courses
rows = db.execute('SELECT code FROM uvsTCB WHERE typeUV = "TM" AND semestre = "Printemps" AND typeBranche = "ISI" ORDER BY code ');
